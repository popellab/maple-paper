...
MAPLE (the SubmodelTarget and CalibrationTarget schemas, validation framework, and Julia code generator) is available at \url{https://github.com/popellab/maple}. The PDAC calibration targets used in this study (\nTargets{} SubmodelTargets and \ctTotal{} CalibrationTargets) are provided as supplementary YAML files. Generated Julia inference scripts are included in the supplementary materials.
